 ...
 */
@Component
public class AdapterEstadoInglesEspanol implements EstadoClimaEspanol {
    
    @Autowired
    EstadoClimaIngles estadoClimaIngles;
    
    @Override
    public void setEstado(EstadoClimaIngles estadoClimaIngles) {
        this.estadoClimaIngles = estadoClimaIngles;
    }

    @Override
    public String getEstado() {
        String estado = "";
        switch(estadoClimaIngles.getEstado()) {
